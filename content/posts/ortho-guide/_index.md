...
*A formal guide for writing and formatting*

This manual is divided into ten interrelated sections:

1. [Accessibility](./accessibility/)
2. [Spelling and Word Usage](./spelling-and-word/)
3. [Typography](./typography-and-symbols/)
4. [Numbers](./numbers/)
5. [Punctuation](./punctuation/)
6. [Grammar and Writing Style](./grammar-and-writing/)
7. [Document Structure and Formatting](./formatting/)
8. [Citation and Reference Practices](./citation-practices/)
9. [Technical and Code-Related Conventions](./code-and-technical-writing/) 
